...
![Workflow](../../images/documentation/pcb-manufacturing/workflow.png)
...
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/print.jpg" alt="Print" width="280">
    <img src="../../../images/documentation/pcb-manufacturing/page-setup.jpg" alt="PDF" width="280">   
</div>
</center>
...
<center>
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/pdf.jpg" alt="Print" width="280">
    <img src="../../../images/documentation/pcb-manufacturing/save-as.jpg" alt="Save As" width="280">   
</div>
</center>
...
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/QTtraces.png" alt="QTraces" width="180">
    <img src="../../../images/documentation/pcb-manufacturing/QTholes.png" alt="QTHoles" width="180">
    <img src="../../../images/documentation/pcb-manufacturing/QToutline.png" alt="QtOutline" width="180">    
</div>
<br>
...
<center>
<img src="../../../images/documentation/pcb-manufacturing/what-i-had.jpg" alt="Start" width="300">
</center>

Then, I chose Object > Expand everything over everything.
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
  <img src="../../../images/documentation/pcb-manufacturing/object-expand.jpg" alt="Object Expand" width="180">
    <img src="../../../images/documentation/pcb-manufacturing/expand-options.jpg" alt="Expand" width="180">   
</div>
<br>

Now go over to the Window tab and open the Pathfinder.
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/window-pathfinder.jpg" alt="Pathfinder" width="180"> 
</div>
<br>
...
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/pathfinder-second-option.jpg" alt="Second Option" width="250"> 
    <img src="../../../images/documentation/pcb-manufacturing/patchinder-unite.jpg" alt="Unite" width="250">   
</div>
<br>

And Voilà :D You can now change the color of your outlines to get an inverted PNG that looks like this!
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/my-traces.jpg" alt="My Traces" width="300"> 
</div>
<br>
Here is the outline:
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/outline.png" alt="My Traces" width="300"> 
</div>
<br>
...
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/right-click.jpg" alt="Right click" width="100">
    <img src="../../../images/documentation/pcb-manufacturing/open-program.jpg" alt="Open program" width="200"> 
    <img src="../../../images/documentation/pcb-manufacturing/select-tool.jpg" alt="Select machine" width="200"> 
</div>
<br>
You should be looking at something like this:
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/looks like this.jpg" alt="Something like this" width="300"> 
</div>
<br>
...
You should be looking at something like this:
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/set-pcb-defaults.jpg" alt="Something like this" width="300"> 
</div>
<br>

Now you should see some default settings here at **mill raster**:
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/mill-raster.jpg" alt="Mill Raster" width="600"> 
</div>
<br>
...
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/enable.jpg" alt="Enable" width="200"> 
    <img src="../../../images/documentation/pcb-manufacturing/speed-and-origin.jpg" alt="Speed and Origin" width="200"> 
</div>
<br>
...
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/VPanel.jpg" alt="VPanel" width="400"> 
</div>
<br>
...
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/Bottom-left.jpg" alt="Bottom Left" width="400"> 
</div>
<br>
...
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/X-Y-origin.jpg" alt="X/Y origin" width="400"> 
</div>
<br>
...
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/Z-origin.jpg" alt="Z origin" width="400"> 
</div>
<br>
...
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/output-cut.jpg" alt="Output" width="400"> 
</div>
<br>
...
![Board Came Out](../../images/documentation/pcb-manufacturing/board-came-out.jpg)
...
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/mistakes.jpg" alt="Mistakes" width="200"> 
</div>
<br>
...
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/file-board-setups.jpg" alt="Board Setup" width="200"> 
</div>
<br>
<div style="display: flex;justify-content: center; gap: 10px; align-items: flex-start;">
    <img src="../../../images/documentation/pcb-manufacturing/clearence.jpg" alt="Clearence" width="600"> 
</div>
<br>
...
![Heart Castle Schematic](../../images/documentation/pcb-manufacturing/Heart-Castle-Schematic.jpg)

As promissed during week 6, I picked a *funny shape* for the outline, forcing my connections -or wiring- to get a little weird. 

![Heart Castle PCB Editor](../../images/documentation/pcb-manufacturing/Heart-Castle-PCB-Editor.jpg)
...
![3D Model](../../images/documentation/pcb-manufacturing/3D-model.jpg)
![Render](../../images/documentation/pcb-manufacturing/render.png)
